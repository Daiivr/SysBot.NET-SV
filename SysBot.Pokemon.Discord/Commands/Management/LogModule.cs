...
namespace SysBot.Pokemon.Discord
{
    public class LogModule : ModuleBase<SocketCommandContext>
    {
        ...
        public static void RestoreLogging(DiscordSocketClient discord, DiscordSettings settings)
        {
            ...
            LogUtil.LogInfo("Se ha añadido el registro en los canales de Discord al iniciar el bot.", "Discord");
        }

        [Command("logHere")]
        [Summary("Hace que el bot se registre en el canal.")]
        [RequireSudo]
        ...
        [Command("logClearAll")]
        [Summary("Borra todos los ajustes de registro.")]
        [RequireSudo]
