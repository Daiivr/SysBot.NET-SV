...
public class BotModule<T> : ModuleBase<SocketCommandContext> where T : PKM, new()
{
    ...
    [Command("botIdle")]
    [Alias("botPause")]
    [Summary("Ordena a un bot que permanezca inactivo por dirección IP/puerto.")]
    [RequireSudo]
    ...
    [Command("botChange")]
    [Summary("Cambia la rutina de un bot (intercambios).")]
    [RequireSudo]
    ...
    [Command("botRestart")]
    [Summary("Reinicia los bots por dirección IP, separados por comas.")]
    [RequireSudo]
