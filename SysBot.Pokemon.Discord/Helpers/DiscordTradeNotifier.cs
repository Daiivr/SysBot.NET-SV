    ...
    public class DiscordTradeNotifier<T> : IPokeTradeNotifier<T> where T : PKM, new()
    {
        ...
        public void TradeFinished(PokeRoutineExecutor<T> routine, PokeTradeDetail<T> info, T result)
        {
            ...
            if (fin.Species != 0 && Hub.Config.Trade.TradeDisplay && fin is PK9 pk9)
            {
                ...
                // Check if tera is equal to 99 (Stellar)
                if (tera == "99")
                {
                    // Use the emoji for Stellar
...

                {
                    ...
                    case (1020, 0): //Gouging Fire
                        embedColor = fin.IsShiny ? new Color(148, 76, 28) : new Color(117, 67, 21);
                        break;
                    case (1021, 0): //Raging Bolt
                        embedColor = fin.IsShiny ? new Color(245, 216, 15) : new Color(237, 158, 0);
                        break;
                    case (1023, 0): //Iron Crown
                        embedColor = fin.IsShiny ? new Color(54, 176, 195) : new Color(202, 202, 202);
                        break;
                    case (1022, 0): //Iron Boulder
                        embedColor = fin.IsShiny ? new Color(66, 52, 49) : new Color(172, 173, 173);
                        break;
                    case (1024, 0): //Terapagos
                        embedColor = fin.IsShiny ? new Color(23, 11, 91) : new Color(0, 226, 255);
                        break;
                    case (1019, 0): //Hydrapple
                        embedColor = fin.IsShiny ? new Color(223, 50, 33) : new Color(254, 204, 17);
                        break;
                    case (1018, 0): //Archaludon
                        embedColor = fin.IsShiny ? new Color(234, 236, 247) : new Color(141, 159, 171);
                        break;
