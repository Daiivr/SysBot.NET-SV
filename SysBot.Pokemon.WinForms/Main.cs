...
public sealed partial class Main : Form
{
    ...
    private void B_Stop_Click(object sender, EventArgs e)
    {
        ...
        if ((ModifierKeys & Keys.Control) != 0 || (ModifierKeys & Keys.Shift) != 0) // either, because remembering which can be hard
        {
            ...
            {
                WinFormsUtil.Alert("Ordenar a todos los robots que reanuden su tarea original", "Pulsar Stop (sin una tecla modificadora) para detener y desbloquear el control.");
        ...
        private void B_RebootStop_Click(object sender, EventArgs e)
        {
            ...
            Task.Run(async () =>
            {
                ...
                if (Bots.Count == 0)
                    WinFormsUtil.Alert("No hay bots configurados, pero todos los servicios de apoyo han recibido el comando de reinicio.");
            });
        }
